                ...
                <div className={`bg-slate-600`}>
                  {query.chainlinkRequestId ? (
                    <CopyButton text={query.chainlinkRequestId}>
                      <p className='mx-2 pt-1.5 hover:text-gray-300 truncate h-8'>
                        {query.chainlinkRequestId}
                      </p>
                    </CopyButton>
                  ) : pending ? (
                    ...
                    <p className='justify-center pt-1.5 flex h-8'>- -</p>
                  )}
                </div>
              </div>
            </div>
                ...
                {query.freePlank ? (
                  <CopyButton text={plankConversion(query.freePlank)?.toString()}>
                    <div className='flex flex-row justify-center items-center'>
                      ...
                      <p className='text-[.6rem] pl-0.5 flex items-center truncate hover:text-gray-300'>
                        KSM
                      </p>
                    </div>
                  </CopyButton>
